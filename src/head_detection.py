### Contains functions to detect attention heads and generate detection patterns ###
...
from src.utils import is_square, is_lower_triangular

# Supported head names (can be used by detection functions
